...
@Component({
  selector: 'app-gratitude-message-informed-denied',
  templateUrl: './gratitude-message-informed-denied.component.html',
  styleUrls: ['./gratitude-message-informed-denied.component.css']
})
export class GratitudeMessageInformedDeniedComponent implements OnInit {

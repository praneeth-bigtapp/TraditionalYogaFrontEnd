...
export class GlimpemediaComponent implements OnInit {
  ...
  displayedColumns: string[] = ['classMediaId', 'date', 'glimpse', "language", "Action"];
  shortvideoform!: any
  filterData: any;
  ...
  ngOnInit(): void {
    console.log(Object.values(this.languagelist));
  ...
  glimpseformsubmit() {
    ...
    const { language, courseMediaId, date, file } = this.glimpseform.value
